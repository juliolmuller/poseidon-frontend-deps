...
} from "./chunk-URBMTVTH.js";
import {
  _assertThisInitialized
} from "./chunk-OVWYYJ6T.js";
import {
  _inheritsLoose,
  init_inheritsLoose
} from "./chunk-TYHM3IP3.js";
import {
...
var ServerStyleSheets = class {
  ...
  collect(children) {
    const sheetsManager2 = /* @__PURE__ */ new Map();
...
function styled(Component) {
  const componentCreator = (style, options = {}) => {
    ...
    const StyledComponent = React4.forwardRef(function StyledComponent2(props, ref) {
      ...
      const className = clsx_m_default(classes.root, classNameProp);
      let spread = other;
      if (filterProps) {
